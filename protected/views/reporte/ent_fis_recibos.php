<h3>Verificación entrega física de recibos</h3>
...
<div class="btn-group" style="padding-bottom: 2%">
  ...
  <button type="submit" class="btn btn-success" onclick="return valida_opciones(event);" id="btn_submit"><i class="fa fa-check"></i> Verificar recibos seleccionados</button>
</div> 
